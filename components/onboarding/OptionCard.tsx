  ...
  return (
    <motion.button
      ...
      style={{
        ...
        width: "100%",
        textAlign: "left",
        background: selected ? "rgba(245, 158, 11,0.12)" : "#0A0A0A",
        ...
        fontWeight: 600,
        cursor: "pointer",
        boxShadow: selected ? "0 0 24px rgba(245, 158, 11,0.2)" : "none",
    ...
    >
      ...
      <span
        style={{
          ...
          height: 20,
          borderRadius: "50%",
          border: `1.5px solid ${selected ? "#F59E0B" : "rgba(255,255,255,0.25)"}`,
