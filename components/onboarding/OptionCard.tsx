  ...
  return (
    <motion.button
      ...
      style={{
        ...
        width: "100%",
        textAlign: "left",
        background: selected ? "rgba(194, 102, 10,0.12)" : "#0A0A0A",
        border: `1px solid ${selected ? "#C2660A" : "rgba(255,255,255,0.1)"}`,
        borderRadius: 16,
        padding: "18px 20px",
        color: "#fff",
        fontSize: 16,
        fontWeight: 600,
        cursor: "pointer",
        boxShadow: selected ? "0 0 24px rgba(194, 102, 10,0.2)" : "none",
    ...
    >
      ...
      <span
        style={{
          ...
          height: 20,
          borderRadius: "50%",
          border: `1.5px solid ${selected ? "#C2660A" : "rgba(255,255,255,0.25)"}`,
          background: selected ? "#C2660A" : "transparent",
          flexShrink: 0,
          display: "flex",
          alignItems: "center",
