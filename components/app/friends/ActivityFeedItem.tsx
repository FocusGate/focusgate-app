    ...
    <div style={{ display: "flex", alignItems: "center", justifyContent: "space-between", gap: 10, padding: "10px 0", borderBottom: "1px solid rgba(255,255,255,0.06)", fontSize: 14 }}>
      ...
      <button
        ...
        style={{
          ...
          gap: 6,
          flexShrink: 0,
          background: reaction.reactedByMe ? "rgba(255, 176, 32,0.15)" : "transparent",
          border: `1px solid ${reaction.reactedByMe ? "rgba(255, 176, 32,0.4)" : "#26262b"}`,
          color: reaction.reactedByMe ? "#FFB020" : "#9a9da4",
          padding: "6px 12px",
          borderRadius: 999,
          fontSize: 13,
          fontWeight: 700,
